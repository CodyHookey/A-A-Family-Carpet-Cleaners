      ...
      <div className="container py-5 text-center">
        ...
        <div className="row mb-5">
          ...
          <div className="col-12 col-md-4 mb-5 mb-md-0">
            ...
            <p>
              Arrange a time to make sure you get your stuff cleaned when it
              works for you.
            </p>
          </div>
          <div className="col-12 col-md-4">
            ...
            <p>
              We will leave your carpets, sofas and upholstery clean and
              smelling better than when you bought it.
            </p>
          </div>
        </div>
